...
## In practice
Since our above example was under the assumption that $\sigma$ of the population was known, which is never the case in real life, we make the necessary adjustments to our critical values to reflect that of the [t-distribution](/distrib/2025-05-27-t-distribution/t-dist/), which is the distribution of a test statistic computed using standard error in place of standard deviation.
